...
<div class="row">
    <div class="col-md-6 mb-4">
        <div class="card h-100">
            <div class="card-header h5"><i class="bi bi-file-earmark-text"></i> Laporan</div>
            <div class="list-group list-group-flush">
                <a href="<?= site_url('/laporan') ?>" class="list-group-item list-group-item-action"><i class="bi bi-person-lines-fill me-2"></i> Rincian Gaji per Anggota</a>
        ...
        <div class="card h-100">
            <div class="card-header h5"><i class="bi bi-pencil-square"></i> Administrasi</div>
             <div class="list-group list-group-flush">
                ...
                <a href="<?= site_url('/komponen-gaji') ?>" class="list-group-item list-group-item-action"><i class="bi bi-tags-fill me-2"></i> Kelola Komponen Gaji</a>
